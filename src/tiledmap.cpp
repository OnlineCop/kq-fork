...
static string strconv(const char *ptr) { return string(ptr ? ptr : ""); }
...
tmx_map KTiledMap::load_tmx_map(XMLElement const *root) {
  ...
  for (auto xlayer = root->FirstChildElement("layer"); xlayer;
