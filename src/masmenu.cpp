...
static void camp_draw_spell_menu(size_t caster_fighter_index, size_t spell_page, size_t spell_page_cursor)
{
    ...
    Draw.menubox(double_buffer, 80, 12, 18, 1, eBoxFill::TRANSPARENT);
    Draw.print_font(double_buffer, 140, 20, _("Magic"), FGOLD);
    Draw.menubox(double_buffer, 80, 36, 18, 5, eBoxFill::TRANSPARENT);
    kmenu.draw_playerstat(double_buffer, pidx_index, 88, 44);
    Draw.menubox(double_buffer, 80, 92, 18, 12, eBoxFill::TRANSPARENT);
    ...
    Draw.menubox(double_buffer, 40, 204, 28, 1, eBoxFill::TRANSPARENT);
